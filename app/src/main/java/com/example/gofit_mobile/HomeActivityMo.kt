...
class HomeActivityMo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navHostFragment = supportFragmentManager.findFragmentById(R.id.layout_fragment_mo) as NavHostFragment
        btmMenu.setupWithNavController(navHostFragment.navController)
        btmMenu.selectedItemId = R.id.fragmentPresensiInstruktur
    }
}