...
class HomeActivityIns : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navHostFragment = supportFragmentManager.findFragmentById(R.id.layout_fragment) as NavHostFragment
        btmMenu.setupWithNavController(navHostFragment.navController)
        btmMenu.selectedItemId = R.id.fragmentPerizinan
    }
}